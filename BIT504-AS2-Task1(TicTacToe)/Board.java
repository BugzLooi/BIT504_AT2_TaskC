...
public class Board {
	...
	public boolean isDraw() {
		...
		//YOU JUST NEED TO GO THROUGH EACH CELL AND CHECK IF THERE NO EMPTY CELL. SO AS
		//WITH CONSTRUCTING THE CELL, YOU TRAVERSE THE CONTENT OF CELL UISNG THE SAME DOUBLE LOOP AS BELOW. 
		//COMPLETE ???
		for(int row = 0; row < GameMain.ROWS; ++row) {
			for (int col = 0; col < GameMain.COLS; ++col) {             
